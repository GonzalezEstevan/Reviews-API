...
CREATE INDEX review_index ON reviews USING btree (product_id);
...
CREATE INDEX char_idx ON characteristics(review_id);
-- Meta Data
...
DELIMITER ','
CSV HEADER;
CREATE INDEX data_idx ON meta_data(review_id);